...
A small and fast tool to find a search term in files. Created with Rider/Visual Studio with .NET 8

![main.png](images/main.png)

I added some settings to avoid for example to open a big file in the preview window or search just for limited range files
